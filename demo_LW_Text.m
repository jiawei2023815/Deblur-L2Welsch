%% Remark
% This demo using L2-Welsch iterative model to deblur the Pan et al's text datasets.
% Pan et al's text datasets includes 15 image-GT, 8 kernel-GT, and a total of 120 blurred images. It's belongs to a uniform datasets.
...
for img = 1 : 15
    ...
    for blur = 1 : 8
        ...
        % save the results
        saving_path = '../Data_Text/Deblur_L2-Welsch/';
